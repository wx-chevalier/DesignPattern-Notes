  - [整洁与重构](/整洁与重构/README.md)
    ...
    - [命名](/整洁与重构/命名/README.md)
      - [英文替换](/整洁与重构/命名/英文替换.md)
  ...
  - [设计模式基础](/设计模式基础/README.md)
    - [SOLID](/设计模式基础/SOLID/README.md)
      ...
      - [单一职责](/设计模式基础/SOLID/单一职责.md)
      - [开放封闭](/设计模式基础/SOLID/开放封闭.md)
      - [接口隔离](/设计模式基础/SOLID/接口隔离.md)
      - [最少知识](/设计模式基础/SOLID/最少知识.md)
      - [里氏替换](/设计模式基础/SOLID/里氏替换.md)
    - [其他模式](/设计模式基础/其他模式/README.md)
      
    - [创建型模式](/设计模式基础/创建型模式/README.md)
      - [单例](/设计模式基础/创建型模式/单例.md)
      - [原型](/设计模式基础/创建型模式/原型.md)
      - [工厂方法](/设计模式基础/创建型模式/工厂方法.md)
      - [抽象工厂](/设计模式基础/创建型模式/抽象工厂.md)
      - [构建器](/设计模式基础/创建型模式/构建器.md)
    - 基础范式
      - [命令式编程](/设计模式基础/基础范式/命令式编程.md)
      - [声明式编程](/设计模式基础/基础范式/声明式编程.md)
    - 结构型模式
      - [享元](/设计模式基础/结构型模式/享元.md)
      - [代理](/设计模式基础/结构型模式/代理.md)
      - [外观](/设计模式基础/结构型模式/外观.md)
      - [桥接](/设计模式基础/结构型模式/桥接.md)
      - [组合](/设计模式基础/结构型模式/组合.md)
      - [装饰](/设计模式基础/结构型模式/装饰.md)
      - [适配器](/设计模式基础/结构型模式/适配器.md)
    - [行为型模式](/设计模式基础/行为型模式/README.md)
      - [中介者](/设计模式基础/行为型模式/中介者.md)
      - [命令](/设计模式基础/行为型模式/命令.md)
      - [备忘录](/设计模式基础/行为型模式/备忘录.md)
      - [模板方法](/设计模式基础/行为型模式/模板方法.md)
      - [状态](/设计模式基础/行为型模式/状态.md)
      - [策略](/设计模式基础/行为型模式/策略.md)
      - [职责链](/设计模式基础/行为型模式/职责链.md)
